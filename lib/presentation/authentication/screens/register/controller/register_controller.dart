...
class RegisterController {
  ...
  Future<void> handleSignUp(BuildContext context) async {
    ...
    // Get the user type: mechanic or customer
    final userType = Global.storageServices.getUserType(); // Get user type
    ...
    try {
      await authenticationController.signUp(
        ...
        state.name,
        userType!,
        context, // Pass user type here
      );

      // Navigate to AdditionalDetailsScreen after successful sign-up
